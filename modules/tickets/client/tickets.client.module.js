(function (app) {
  ...
  app.registerModule('tickets', ['core', 'moment-picker', 'ngFileUpload']);// The core module is required for special route handling; see /core/client/config/core.client.routes
